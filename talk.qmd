...
Suppose we want to coinduce an idealised universe where the disk *always* moves $-1$. We mathematically *propose* the Greatest Fixpoint (using the exact same fixpoint architecture as our property persistence):
$$
ParityInvariant \equiv \nu Z.\ \langle -1 \rangle Z
$$

*The problem:* This sequence also generates a jump of $+2$, so how can our idealised Greatest Fixpoint survive this contradiction?
